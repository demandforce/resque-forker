...
Make sure to require "resque/capistrano" at the top of your Capfile and
associate worker instances with the roles :worker.
...
If you're using RVM and have a system-wide install, you'll want to create a
wrapper first, for example:
